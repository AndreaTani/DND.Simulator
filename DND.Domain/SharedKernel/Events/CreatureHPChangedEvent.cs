namespace DND.Domain.SharedKernel
{
    ...
    /// <param name="CreatureName">name of the creature whose HP changed</param>
    ...
    /// <param name="DamageType">DamageType of Damage sustained, default None for healing</param>
